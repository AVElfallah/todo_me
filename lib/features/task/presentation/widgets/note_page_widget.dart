...
class NotePageWidget extends StatelessWidget {
  const NotePageWidget({super.key, this.isAnimated = false, this.children, this.containerColor=Colors.black}):assert(children != null);

  factory NotePageWidget.withEndTaskContainer(){
return NotePageWidget(
  isAnimated: false,
  containerColor: Colors.black.withValues(alpha: .25),
  children: [
